...
<TD valign="top"><br>
  <table width="97%" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td width="37%" background="pics/heading_bg.gif"><div align="left">&nbsp;&nbsp;<span class="bodysg">Modify Main Photo </span></div></td>
      <td width="63%">&nbsp;</td>
    </tr>
  </table>
  <table width="97%" border="0" align="center" cellpadding="0" cellspacing="0" class="submenubox">
    <tr>
	  ...
	  <table width="97%" border="0" align="center" cellpadding="3" cellspacing="3">
        <tr>
          <td colspan="2">Modify/Change  your main photo<br>
        ...
        <tr>
          <td width="27%">Select your main photo :</td>
          <td width="73%"><input name="__upload" type="file" class="addtextfiled" size="35" /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
