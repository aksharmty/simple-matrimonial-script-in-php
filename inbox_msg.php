...
$sql = mysql_query("SELECT *,Left(Msg,30) as text from receivemessage where ToID = '$strid' order by rid desc LIMIT $from, $max_results ");
  ...
  <table width="97%" border="0" align="center" cellpadding="0" cellspacing="0" class="submenubox">
    <tr>
      <td><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td>Listed Below are <strong>Received Personalised </strong>messages.</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
...
?>
  ...
  <tr>
    <td colspan="4" ><input name="topcheckbox" type="checkbox" class="check" id="topcheckbox" onClick="selectall();" value="ON" />
...
<table  height="0" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="61" ><input name="<?php echo $row['rid']?>" type="checkbox" class="check" /></td>
