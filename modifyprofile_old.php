...
?>
        ...
        <tr>
          <td colspan="2"><span class="h3r">Socio Religious Attributes</span><span class="bodysg"> &nbsp;
...
?>
        ...
        <tr>
          <td colspan="2"><span class="h3r">Education and Occupation</span><span class="bodysg"> &nbsp;
                <input name="Submit2" type="image" value="Submit" src="pics/edit_but.gif" align="absmiddle">
          </span></td>
        </tr>
        <tr>
...
?>
        ...
        <tr>
          <td colspan="2"><span class="h3r">Physical Attributes </span><span class="bodysg"> &nbsp;
                <input name="Submit2" type="image" value="Submit" src="pics/edit_but.gif" align="absmiddle">
          </span></td>
        </tr>
        <tr>
