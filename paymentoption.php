                    ...
                    <tbody>
                      <tr>
                        ...
                        style="FONT-SIZE: 11px; COLOR: #1670ae; FONT-FAMILY: verdana"><b>
                          ...
                          &nbsp;days </b></font></div></td>
                        <td width="71" valign="center"><div align="left"><span class="Partext1">Rs. <?php  echo $row['planamount']?>
                        </span></div></td>
...
{
?>	
<td width="71" valign="center"><div align="center"><a href="login.php">Pay now </a></div></td>
<?
}
else
{
?>
<td width="71" valign="center"><div align="center"><a href="membership.php">Pay now </a></div></td>
<?
}
?>						
