...
<a href="#">
				  <img src="../photoprocess_small.php?image=<?php echo $row['Photo2']?>" width="100" height="100" hspace="1" vspace="1" border="0" class="submenubox" onClick="MM_openBrWindow('viewphoto2.php?id=<?php  echo $row['MatriID']?>&Choice=1','vp','resizable=yes,width=600,height=450')"/>
</a>
  </div>
				   
				   </td>
                  <td class="smalltextgrey"><a href="Approve_photo2_submit.php?ID=<?php echo $row['MatriID']?>&amp;Action=approve">Approve Photo </a></td>
                  <td class="smalltextgrey"><a href="UnApprove_photo2_submit.php?ID=<?php echo $row['MatriID']?>&amp;delphoto=<?php echo $row['Photo1']?>&amp;Action=unapprove&email=<?php echo $row['ConfirmEmail']?>&name=<?php echo $row['Name']?>">Un Approve Photo </a></td>
