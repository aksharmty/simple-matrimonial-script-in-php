...
$update = mysql_query("UPDATE siteconfig set Webname = '".$_POST['txtwebsitename']."',WebFriendlyname ='".$_POST['txtwebsitefriendlyname']."',Weblogopath = '".$_POST['txtwebsitelogopath']."',Title ='".$_POST['txtwebtitle']."',Description ='".$_POST['txtwebmetadesc']."',Keywords ='".$_POST['txtwebmetakeywords']."',Footer='".$_POST['txtwebfooter']."',Dbserver='".$_POST['txtdbserver']."',Dbuser = '".$_POST['txtdbusername']."',Dbpass = '".$_POST['txtdbpassword']."',Dbname = '". $_POST['txtdbname']."',Fromemail= '".$_POST['txtFromemail']."', ToEmail = '".$_POST['txtToEmail']."',FeedbackEmail ='".$_POST['txtFeedbackEmail']."', ContactEmail = '".$_POST['txtContactusemail']."',SalesEmail= '".$_POST['txtSalesEmail']."' WHERE ID='1' ")
