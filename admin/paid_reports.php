...
$result = mysql_query("SELECT MatriID,ConfirmEmail,Name,Gender,Regdate,Status FROM register where Status <> 'InActive' and Status <> 'Active' and Status <> 'Featured' LIMIT $from, $max_results "); 
...
$total_results = mysql_result(mysql_query("SELECT COUNT(*) as Num FROM register where Status <> 'InActive' and Status <> 'Active' and Status <> 'Featured' "),0);  
