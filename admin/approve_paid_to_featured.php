...
$sql = mysql_query("SELECT * FROM register where Status != 'Active' and Status != 'InActive' and Status != 'featured' LIMIT $from, $max_results"); 
...
<title>Approve Paid Members To Featured Members</title>
</head>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" id="inner">
      ...
      <tr>
		...
		<form action="approve_paid_to_featured_submit.php" method="post" name="form1" id="form1" onSubmit="return approvevalidate()">
          ...
          <tr>
            <td height="54" colspan="4" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="97%" class="headertext">PLATINUM MEMBERS <span class="paratext">(Waiting for Approval)</span> </td>
              </tr>
            </table>
              <br />
              <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td><div align="center" class="smalltextgrey">
                    <div align="left" class="smalltextred"> Below is the list of all Platinum Profiles waiting approval. You can click on the profile ID to view the registrant details.You can   convert the active/free member  by clicking active link </div>
                  </div></td>
                </tr>
              </table>
              <br />
...
$total_results = mysql_result(mysql_query("SELECT COUNT(*) as Num FROM register where status ='PLATINUM' "),0); 
...
?>
              ...
              <table width="98%" border="0" align="center" cellpadding="4" cellspacing="0" class="blackbox">
                ...
                <tr>
                  ...
                  <td width="22%" bgcolor="#ECECEC" class="paratext">Email</td>
                  <td width="19%" bgcolor="#ECECEC" class="paratext">Name</td>
                  <td width="12%" bgcolor="#ECECEC" class="paratext">Reg On</td>
                  <td width="11%" bgcolor="#ECECEC" class="paratext">Status</td>
                  <td width="10%" bgcolor="#ECECEC" class="paratext">View Profile </td>
