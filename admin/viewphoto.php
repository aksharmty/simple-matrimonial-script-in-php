...
<div align="center"> <img src="../photoprocess.php?image=<?php  echo $row['Photo1']?>&maxim_size=400&watermark_text=<?php echo $info['Webname']; ?>&watermark_color=ffffff;" 
...
?>
<div align="center"> <img src="../photoprocess.php?image=<?php  echo $row['Photo2']?>&maxim_size=400&watermark_text=<?php echo $info['Webname']; ?>&watermark_color=ffffff;" 
alt="I am <?php  echo $row['Age']?>,<?php echo $row['Maritalstatus']?>,<?php  echo $row['Religion']?>,<?php  echo $row['Gender']?>  living in <?php  echo $row['State']?>,<?php echo $row['Country']?>" hspace="1" vspace="1" border="0" class="submenubox" /> </div>
              <? } 
else if($_GET['Choice']=="3") {
?>
                <div align="center"> <img src="../photoprocess.php?image=<?php  echo $row['Photo3']?>&&maxim_size=400&watermark_text=<?php echo $info['Webname']; ?>&watermark_color=ffffff;" 
alt="I am <?php  echo $row['Age']?>,<?php echo $row['Maritalstatus']?>,<?php  echo $row['Religion']?>,<?php  echo $row['Gender']?>  living in <?php  echo $row['State']?>,<?php echo $row['Country']?>" hspace="1" vspace="1" border="0" class="submenubox" /> </div>
              <? } 
?>
            </td>
