...
$sql = mysql_query("SELECT * FROM register where status = '$strstatus' LIMIT $from, $max_results"); 
...
$total_results = mysql_result(mysql_query("SELECT COUNT(*) as Num FROM register where status = '$strstatus' "),0); 
