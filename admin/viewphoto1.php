        ...
        <table width="590" border="0" align="center" cellpadding="2" cellspacing="2">
          <tr>
            ...
            <?php  echo $row['MatriID']?>
              ...
              <div align="center">
              <div align="center"> <img src="../<?php  echo $row['Photo1']?>" 
alt="I am <?php  echo $row['Age']?>,<?php echo $row['Maritalstatus']?>,<?php  echo $row['Religion']?>,<?php  echo $row['Gender']?>  living in <?php  echo $row['State']?>,<?php echo $row['Country']?>" hspace="1" vspace="1" border="0" class="submenubox" onClick="MM_openBrWindow('viewphoto.php?id=<?php  echo $row['MatriID']?>&amp;Choice=1','vp','resizable=yes,width=600,height=450')" />  </div>
              </div>
