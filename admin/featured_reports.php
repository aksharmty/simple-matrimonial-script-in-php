...
$result = mysql_query("SELECT MatriID,ConfirmEmail,Name,Gender,Regdate,Status FROM register where Status <> 'InActive' and Status <> 'Active' and Status <> 'GOLD' and Status <> 'DIAMOND' and Status <> 'PLATINUM' LIMIT $from, $max_results "); 
...
<title>Featured Member Reports</title>
</head>
...
$total_results = mysql_result(mysql_query("SELECT COUNT(*) as Num FROM register where Status <> 'InActive' and Status <> 'Active' and Status <> 'GOLD' and Status <> 'DIAMOND' and Status <> 'PLATINUM' "),0);  
