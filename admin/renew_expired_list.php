...
?>
              ...
              <table width="600" border="0" align="center" cellpadding="2" cellspacing="0" class="blackbox">
                ...
                <tr>
                  ...
                  <td width="199" bgcolor="#ECECEC" class="paratext">Membership Expired on </td>
          ...
          ?>
                <tr>
                  ...
                  <td height="20"> <a href="#" onClick="newWindow('approve_paid_form.php?id=<?php  echo $row['MatriID']?>','','400','400')">Renew Now </a></td>
