...
<table width="97%" border="0" align="center" cellpadding="0" cellspacing="0" class="submenubox">
  <tr>
	...
	<table width="98%" border="0" align="center" cellpadding="2" cellspacing="2">
      ...
      <tr>
        <td>To : <? echo $strtoid ?> <input name="txtTo" type="hidden" id="txtTo" value="<? echo $strtoid ?>" /></td>
      </tr>
      <tr>
        <td><div align="left">
          <textarea name="txtreply" cols="60" rows="10" id="txtreply">--------Original Message------
		 < <? echo $row['Msg'] ?></textarea>
</div></td>
        </tr>
      <tr>
