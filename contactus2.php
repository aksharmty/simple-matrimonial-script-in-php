...
<p class="smr-top">
        ...
        <b class="pp"><a href="registration1.php" title="Post Profile">Post Profile</a></b>
...
<ul>
   ...
   <li class="sr-menudivider"></li>
   <li><a href="registration1.php"><span>Free Register</span></a></li>
   <li class="sr-menudivider"></li>
   ...
   <li><a href="contactus.php"><span>Contact Us</span></a></li>
    ...
    <div class="sr-rightmenuboxBg"></div>
                ...
                <!-- end menu -->
		   <div><h3><strong style="font-size: 16px; ">Contact US<div><img src="images/contct-l-img.jpg" height="500" width="500" style="float: right; "><p>You can choose from many ways to reach us. Here we are:</p><ul><li><strong style="font-size: 16px; "><span style="color: rgb(191, 35, 41); ">Sukhmayrishtey.com</span></strong><br>1558/30, 3rd floor,&nbsp;<br>Gali Nai Wala,&nbsp;<br>karol Bagh,<br>New Delhi-110005.<br><br></li><li><strong style="font-size: 16px; ">Call us at:&nbsp;<span style="color: rgb(191, 35, 41); ">+91- 8826007867, +91- 8826007868</span></strong><br>We answer all calls from 09 AM to 10 PM (Mon. to Sun.)<br><br></li></ul></div></div><div><br class="Apple-interchange-newline"></div>
