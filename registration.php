...
<script language="javascript" src="includes/relcaste.js"></script>
...
var jChars = "!@#$%^&*()+=-[]\\\';,./{}|\":<>?0123456789";
  ...
  for (var k = 0; k < MatriForm.txtPb.value.length; k++) {
  	if (kChars.indexOf(MatriForm.txtPb.value.charAt(k)) != -1) {
  	alert ("Special characters and numbers are not allowed in Place of Birth.\n Please remove them.");
	MatriForm.txtPb.focus();
  	return false;
  	}
  }
...
<form action="registration3.php" method="post" name="MatriForm" onSubmit="return Validate()" >
<div align="center">
  
  <table width="980" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="BlueTborder">
    <!--DWLayoutTable-->
    <tr>
            ...
            <td height="206" colspan="2">
				...
				<!---- -->		
                              ...
                              <TR class=tabpadding>
                                ...
                                <TD><div align="left">
                                  <input name="txtName" type="text" class="forminput" id="txtName" size="40" maxlength="40" style="width:215px;" onKeyUp="nospaces(this)">
                                </div></TD>
                              </TR>
...
Not living with me </div></TD>
			...
			<!-- -->	  
                              ...
                              <TR class=tabpadding>
                                ...
                                <TD><div align="left">
                                  <input name="txtp" type="password" class="forminput" id="txtp" size="10" maxlength="10" style="width:215px;" onKeyUp="nospaces(this)">
                                </div></TD>
                              </TR>
                              <TR>
                                <TD class=grebg colSpan=2><IMG height=1  src="pics/trans.gif"></TD>
                              ...
                              <TR class=tabpadding>
                                ...
                                <TD class=grtxt><div align="left">
                                  <input name="txtcp" type="password" class="forminput" id="txtcp" size="10" maxlength="10" style="width:215px;" onKeyUp="nospaces(this)">
                                </div></TD>
                              </TR>
